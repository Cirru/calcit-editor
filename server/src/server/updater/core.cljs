...
(defn updater [db op op-data session-id op-id op-time]
  (case op
    ...
    :writer/peek-ns (writer/peek-ns db op-data session-id op-id op-time)
    ...
    :ir/draft-expr (ir/draft-expr db op-data session-id op-id op-time)
    :ir/replace-file (ir/replace-file db op-data session-id op-id op-time)
