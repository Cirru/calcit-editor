...
(ns app.theme
  (:require [app.theme.star-trail :as star-trail] [app.theme.curves :as curves]))

(defn base-style-expr [theme]
  (case theme :star-trail star-trail/style-expr :curves curves/style-expr {}))

(defn base-style-leaf [theme]
  (case theme :star-trail star-trail/style-leaf :curves curves/style-leaf {}))
